							...
							<div class="row justify-content-center align-items-center h-100">
								<div class="col-md-10">
									<div class="px-3 px-md-0 py-5 py-md-0">
										...
										<p class="mb-0">Обратите внимание на график работы в праздничные дни: заявки будут приниматься <span>4 и 5 января</span>, а выполнение — <span>5 и 9 января.</span></p>
									</div>
								</div>
							</div>
						</div>
